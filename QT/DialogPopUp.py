...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(310, 175)
        Dialog.setMinimumSize(QtCore.QSize(310, 175))
        Dialog.setMaximumSize(QtCore.QSize(310, 175))
        self.buttonBox = QtGui.QDialogButtonBox(Dialog)
        self.buttonBox.setGeometry(QtCore.QRect(10, 130, 290, 30))
