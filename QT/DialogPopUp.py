...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cb_typeInvest.setItemText(0, _translate("Dialog", "Invest in as much company as possible", None))
        self.cb_typeInvest.setItemText(1, _translate("Dialog", "Invest in as much money as possible", None))
